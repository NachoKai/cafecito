...
if (process.env.DB_USER) {
    urlMongo = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0-1vs3x.mongodb.net/?authSource=admin&w=1`;
} else {
    urlMongo = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0-1vs3x.mongodb.net/`;
}
