...
const HeadCustom = ({ share }) => (
  <Head>
    <meta
      property="og:url"
      content={`${URL}${share && share._id ? `/coffee/${share._id}` : ""}`}
    />
    <meta property="og:title" content={`${FIRST_NAME} ${LAST_NAME} | Cafecito`} />
    <meta name="og:description" content="" />
    <meta property="og:site_name" content="Cafecito" />

    {share && share._id && (
      <meta property="og:image" content={`${URL}/static/imagesCoffee/${share._id}.png`} />
    )}
    <link
    ...
    {share && share._id && (
      <meta itemProp="image" content={`${URL}/static/imagesCoffee/${share._id}.png`} />
    )}
  </Head>
);
