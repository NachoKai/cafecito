        ...
        <>
          ...
          <div className={style.containerInputCoffee}>
            <div className={style.imageCoffee}>
              <img src="/static/imgs/coffee.png" height="50" alt="" />
              <span>$50</span>
            </div>
            ...
            <div className={style.countCoffeesContainer}>
              <button
                onClick={() => {
                  if (countCoffees > 1) {
                    setCountCoffees(preCountCoffees => Number(preCountCoffees) - 1);
                  }
                }}
              >
                -
            ...
            <div className={style.buttonCoffeesContainer}>
              <button
                className={`${parseInt(countCoffees) === 1 ? style.selected : null}`}
                onClick={() => {
                  setCountCoffees(1);
                }}
              >
              ...
              <button
                className={`${parseInt(countCoffees) === 3 ? style.selected : null}`}
                onClick={() => {
                  setCountCoffees(3);
                }}
              >
              ...
              <button
                className={`${parseInt(countCoffees) === 5 ? style.selected : null}`}
                onClick={() => {
                  setCountCoffees(5);
                }}
              >
